...
func (mr *MockQueryBuilderMockRecorder) Delete(table, cond interface{}) *gomock.Call {
...
func (mr *MockQueryBuilderMockRecorder) Update(table, data, cond interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
