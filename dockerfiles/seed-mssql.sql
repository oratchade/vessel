...
INSERT INTO [TestDB].[dbo].[users] (id, name, email, age, status) VALUES
...
INSERT INTO [TestDB].[dbo].[posts] (id, user_id, title, content, published) VALUES
...
INSERT INTO [TestDB].[dbo].[comments] (id, post_id, user_id, content) VALUES
...
DBCC CHECKIDENT ('[TestDB].[dbo].[users]', RESEED, 5)
DBCC CHECKIDENT ('[TestDB].[dbo].[posts]', RESEED, 5)
DBCC CHECKIDENT ('[TestDB].[dbo].[comments]', RESEED, 7)
